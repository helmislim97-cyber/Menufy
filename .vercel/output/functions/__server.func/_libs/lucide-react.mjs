...
const ChefHat = createLucideIcon("chef-hat", __iconNode$G);
...
const Facebook = createLucideIcon("facebook", __iconNode$y);
const __iconNode$x = [
  [
    "path",
    {
...
const Store = createLucideIcon("store", __iconNode$7);
const __iconNode$6 = [
