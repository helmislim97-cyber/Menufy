...
function ProductCard({
  ...
  return (
    ...
    >
      {soldOut ? (
        <span className="absolute top-0 end-0 rounded-ee-xl rounded-ss-xl bg-[#1c1f16]/70 px-3 py-1.5 text-xs font-bold uppercase text-white shadow-sm">
          {t("client.soldOut")}
        </span>
      ) : (
        p.badge && (
    ...
    >
      ...
      <Dialog open={cartOpen} onOpenChange={setCartOpen}>
        <DialogContent className="max-h-[90dvh] overflow-y-auto text-[#1c1f16] !top-[5dvh] !translate-y-0 !bottom-[5dvh]" style={{ backgroundColor: bgColor }}>
          ...
          {cartItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-3" style={{ minHeight: "60dvh" }}>
      ...
      <Dialog open={ordersHistoryOpen} onOpenChange={setOrdersHistoryOpen}>
        <DialogContent className="max-h-[90dvh] overflow-y-auto text-[#1c1f16] !top-[5dvh] !translate-y-0 !bottom-[5dvh]" style={{ backgroundColor: bgColor }}>
          ...
          {sessionOrders.length === 0 ? (
            <div className="flex flex-col items-center gap-3" style={{ minHeight: "60dvh", justifyContent: "center" }}>
              <div className="grid h-16 w-16 place-items-center rounded-full bg-[#1c1f16]/5 text-[#1c1f16]/30">
