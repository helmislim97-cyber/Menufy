...
const fr: Dict = {
  ...
  "cashier.recentPayments": "Paiements récents",
  "cashier.noPayments": "Aucun paiement aujourd'hui",
  "cashier.table": "Table",
  "cashier.method.cash": "Espèces",
  "cashier.method.card": "Carte",
  "cashier.method.online": "En ligne",
  "cashier.requestVoid": "Demander l'annulation",
  "cashier.voidRequested": "Annulation demandée",
  "cashier.voidRequestedToast": "Demande envoyée — en attente d'approbation",
  "cashier.voidModalTitle": "Demander l'annulation du paiement",
  "cashier.voidReason.customer_refund": "Remboursement client",
  "cashier.voidReason.wrong_order": "Mauvaise commande",
  "cashier.voidReason.entry_mistake": "Erreur de saisie",
  "cashier.voidReason.other": "Autre",
  "cashier.confirm": "Confirmer",
  "cashier.cancel": "Annuler",
  "cancel.request": "Demander l'annulation",
  "cancel.requested": "Annulation demandée — en attente d'approbation",
  "cancel.error": "Action impossible",
  "cancel.modalTitle": "Demander l'annulation de la commande",
  "cancel.pickOrder": "Quelle commande ?",
  "cancel.order": "Commande",
  "cancel.items": "articles",
  "cancelReason.wrong_order": "Mauvaise commande",
  "cancelReason.customer_left": "Client parti",
  "cancelReason.duplicate": "Doublon",
  "cancelReason.out_of_stock": "Rupture de stock",
  "cancelReason.other": "Autre",
  "edit.request": "Demander une modification",
  "edit.requested": "Modification demandée — en attente d'approbation",
  "edit.error": "Action impossible",
  "edit.modalTitle": "Modifier la commande",
  "edit.newTotal": "Nouveau total",
  "editReason.wrong_item": "Mauvais article",
  "editReason.customer_changed": "Client a changé d'avis",
  "editReason.out_of_stock": "Rupture de stock",
  "editReason.other": "Autre",
  "approvals.removed": "retiré",
  "approvals.newTotal": "Total",
  "sidebar.approvals": "Approbations",
  "approvals.title": "Approbations",
  "approvals.subtitle": "Demandes en attente de votre validation",
  "approvals.empty": "Aucune demande en attente",
  "approvals.action.cancel": "Annulation",
  "approvals.action.edit": "Modification",
  "approvals.action.void_payment": "Annuler le paiement",
  "approvals.table": "Table",
  "approvals.amount": "Montant",
  "approvals.requestedBy": "Demandé par",
  "approvals.reason": "Raison",
  "approvals.note": "Note",
  "approvals.approve": "Approuver",
  "approvals.reject": "Refuser",
  "approvals.approved": "Demande approuvée",
  "approvals.rejected": "Demande refusée",
  "approvals.error": "Action impossible",
  ...
  "client.openingHours": "Horaires d'ouverture",
  ...
  "client.invalidInfoError": "Merci de vérifier votre nom et votre numéro de téléphone.",
  "client.suggestedForYou": "Vous aimerez peut-être aussi",
  "menu.upsellTitle": "Suggestions dans le panier",
  "menu.upsellSubtitle": "Ces produits seront suggérés aux clients juste avant qu'ils confirment leur commande.",
  "menu.upsellAdd": "Ajouter une suggestion",
  "menu.upsellEmpty": "Aucune suggestion configurée.",
  "menu.upsellAdded": "Suggestion ajoutée",
  "menu.upsellDeleted": "Suggestion supprimée",
  "menu.upsellProduct": "Produit",
  "menu.upsellProductPlaceholder": "Choisir un produit",
  "menu.upsellSpecialPrice": "Prix spécial (optionnel)",
  "menu.upsellSpecialPricePlaceholder": "Laisser vide pour le prix normal",
  "menu.upsellSpecialPriceHint": "Si renseigné, ce prix remplacera le prix normal pour cette suggestion.",
  "menu.hideCategory": "Masquer cette catégorie",
  "menu.showCategory": "Afficher cette catégorie",
  "menu.categoryHidden": "Catégorie masquée",
  "menu.categoryShown": "Catégorie affichée",
  "menu.hideProduct": "Masquer ce produit",
  "menu.showProduct": "Afficher ce produit",
  "menu.productHidden": "Produit masqué",
  "menu.productShown": "Produit affiché",
  "sidebar.open": "Ouvrir le menu",
  "sidebar.group.activity": "Activité",
  "sidebar.group.management": "Gestion",
  "sidebar.group.stats": "Statistiques",
  "sidebar.group.account": "Compte",
  "sidebar.home": "Accueil",
  "sidebar.orders": "Commandes",
  "sidebar.assistance": "Appels",
  "sidebar.kitchenMode": "Mode cuisine",
  "sidebar.cashierMode": "Mode caisse",
  "sidebar.loyalty": "Fidélité",
  "sidebar.menu": "Mon menu",
  "sidebar.tables": "Mes tables",
  "sidebar.appearance": "Apparence",
  "sidebar.info": "Infos générales",
  "sidebar.notifications": "Notifications",
  "sidebar.roles": "Rôles",
  "sidebar.rolePerms": "Rôles & permissions",
  "sidebar.staff": "Personnel",
  "staff.switchUser": "Changer d'utilisateur",
  "staff.exit": "Quitter",
  "waiter.title": "Service",
  "waiter.subtitle": "Salle & commandes",
  "waiter.empty": "Aucune commande en cours",
  "waiter.total": "Total",
  "waiter.markPaid": "Encaisser",
  "waiter.newOrder": "Nouvelle commande",
  "waiter.noMenu": "Aucun produit disponible",
  "waiter.selectTable": "Choisir une table",
  "waiter.noTable": "Sans table",
  "waiter.table": "Table",
  "waiter.note": "Note (optionnel)",
  "waiter.send": "Envoyer",
  "waiter.orderSent": "Commande envoyée",
  "waiter.error": "Une erreur est survenue",
  "sidebar.recap": "Récap",
  "sidebar.dailyReport": "Rapport journalier",
  "sidebar.ordersStats": "Commandes",
  ...
  "sidebar.more": "Plus",
  "settings.addZone": "Ajouter une zone",
  "settings.editZone": "Modifier la zone",
  "settings.zoneNamePlaceholder": "Ex: Terrasse",
  "settings.unzoned": "Sans zone",
  "settings.confirmDeleteZone": "Supprimer cette zone ? Les tables seront déplacées vers \"Sans zone\".",
  "settings.brandColor": "Couleur de marque",
  "settings.brandColorHint": "Cette couleur sera utilisée pour les boutons et accents de votre menu client.",
  "settings.bgColor": "Couleur de fond",
  "settings.bgColorHint": "Couleur de fond de votre menu client.",
  "settings.bgPattern": "Fond décoratif",
  "settings.bgPatternHint": "Motif affiché sur le fond de votre menu client.",
  "settings.productLayout": "Mise en page des produits",
  "settings.productLayoutHint": "Choisissez comment les produits s'affichent sur votre menu.",
  "settings.layoutList": "Liste",
  "settings.layoutCarousel": "Carrousel",
  ...
  "client.poweredBy": "Propulsé par",
  "client.allRightsReserved": "Tous droits réservés.",
  "settings.infoOrder": "Ordre des informations",
  "settings.infoOrderHint": "Faites glisser pour réorganiser l'ordre d'affichage sur le menu client.",
  "settings.openingHours": "Horaires d'ouverture",
  "settings.open": "Ouvert",
  "settings.closed": "Fermé",
  "settings.addSlot": "Ajouter une tranche",
  ...
  "settings.tiktokPlaceholder": "https://tiktok.com/@votre-restaurant",
  "settings.twitter": "X (Twitter)",
  "settings.twitterPlaceholder": "https://x.com/votre-restaurant",
...
const ar: Dict = {
  ...
  "cashier.recentPayments": "المدفوعات الأخيرة",
  "cashier.noPayments": "لا مدفوعات اليوم",
  "cashier.table": "طاولة",
  "cashier.method.cash": "نقدا",
  "cashier.method.card": "بطاقة",
  "cashier.method.online": "عبر الإنترنت",
  "cashier.requestVoid": "طلب الإبطال",
  "cashier.voidRequested": "طُلب الإبطال",
  "cashier.voidRequestedToast": "تم إرسال الطلب — بانتظار الموافقة",
  "cashier.voidModalTitle": "طلب إبطال الدفع",
  "cashier.voidReason.customer_refund": "استرداد للعميل",
  "cashier.voidReason.wrong_order": "طلب خاطئ",
  "cashier.voidReason.entry_mistake": "خطأ في الإدخال",
  "cashier.voidReason.other": "أخرى",
  "cashier.confirm": "تأكيد",
  "cashier.cancel": "إلغاء",
  "cancel.request": "طلب الإلغاء",
  "cancel.requested": "طُلب الإلغاء — بانتظار الموافقة",
  "cancel.error": "تعذّر تنفيذ الإجراء",
  "cancel.modalTitle": "طلب إلغاء الطلب",
  "cancel.pickOrder": "أي طلب؟",
  "cancel.order": "طلب",
  "cancel.items": "أصناف",
  "cancelReason.wrong_order": "طلب خاطئ",
  "cancelReason.customer_left": "غادر العميل",
  "cancelReason.duplicate": "مكرر",
  "cancelReason.out_of_stock": "نفد المخزون",
  "cancelReason.other": "أخرى",
  "edit.request": "طلب تعديل",
  "edit.requested": "طُلب التعديل — بانتظار الموافقة",
  "edit.error": "تعذّر تنفيذ الإجراء",
  "edit.modalTitle": "تعديل الطلب",
  "edit.newTotal": "المجموع الجديد",
  "editReason.wrong_item": "صنف خاطئ",
  "editReason.customer_changed": "غيّر العميل رأيه",
  "editReason.out_of_stock": "نفد المخزون",
  "editReason.other": "أخرى",
  "approvals.removed": "أُزيل",
  "approvals.newTotal": "المجموع",
  "sidebar.approvals": "الموافقات",
  "approvals.title": "الموافقات",
  "approvals.subtitle": "طلبات بانتظار موافقتك",
  "approvals.empty": "لا توجد طلبات معلقة",
  "approvals.action.cancel": "إلغاء",
  "approvals.action.edit": "تعديل",
  "approvals.action.void_payment": "إبطال الدفع",
  "approvals.table": "طاولة",
  "approvals.amount": "المبلغ",
  "approvals.requestedBy": "طلب من",
  ...
  "approvals.error": "تعذّر تنفيذ الإجراء",
  ...
  "client.openingHours": "أوقات العمل",
  "client.today": "اليوم",
  "client.closed": "مغلق",
  ...
  "client.invalidInfoError": "يرجى التحقق من اسمك ورقم هاتفك.",
  "client.suggestedForYou": "قد يعجبك أيضًا",
  "menu.upsellTitle": "اقتراحات في السلة",
  "menu.upsellSubtitle": "سيتم اقتراح هذه المنتجات للزبائن قبل تأكيد طلبهم مباشرة.",
  "menu.upsellAdd": "إضافة اقتراح",
  "menu.upsellEmpty": "لا توجد اقتراحات بعد.",
  "menu.upsellAdded": "تمت إضافة الاقتراح",
  "menu.upsellDeleted": "تم حذف الاقتراح",
  "menu.upsellProduct": "المنتج",
  "menu.upsellProductPlaceholder": "اختر منتجًا",
  "menu.upsellSpecialPrice": "سعر خاص (اختياري)",
  "menu.upsellSpecialPricePlaceholder": "اتركه فارغًا لاستخدام السعر العادي",
  "menu.upsellSpecialPriceHint": "إذا تم تحديده، سيحل هذا السعر محل السعر العادي لهذا الاقتراح.",
  "menu.hideCategory": "إخفاء هذه الفئة",
  "menu.showCategory": "إظهار هذه الفئة",
  "menu.categoryHidden": "تم إخفاء الفئة",
  "menu.categoryShown": "تم إظهار الفئة",
  "menu.hideProduct": "إخفاء هذا المنتج",
  "menu.showProduct": "إظهار هذا المنتج",
  "menu.productHidden": "تم إخفاء المنتج",
  "menu.productShown": "تم إظهار المنتج",
  "sidebar.open": "فتح القائمة",
  "sidebar.group.activity": "النشاط",
  "sidebar.group.management": "الإدارة",
  "sidebar.group.stats": "الإحصائيات",
  "sidebar.group.account": "الحساب",
  "sidebar.home": "الرئيسية",
  "sidebar.orders": "الطلبات",
  "sidebar.assistance": "النداءات",
  "sidebar.kitchenMode": "وضع المطبخ",
  "sidebar.cashierMode": "وضع الصندوق",
  "sidebar.loyalty": "الولاء",
  "sidebar.menu": "قائمتي",
  "sidebar.tables": "طاولاتي",
  "sidebar.appearance": "المظهر",
  "sidebar.info": "معلومات عامة",
  "sidebar.notifications": "الإشعارات",
  "sidebar.roles": "الأدوار",
  "sidebar.rolePerms": "الأدوار والصلاحيات",
  "sidebar.staff": "الموظفون",
  "staff.switchUser": "تغيير المستخدم",
  "staff.exit": "خروج",
  "waiter.title": "الخدمة",
  "waiter.subtitle": "القاعة والطلبات",
  "waiter.empty": "لا توجد طلبات جارية",
  "waiter.total": "المجموع",
  "waiter.markPaid": "تحصيل",
  "waiter.newOrder": "طلب جديد",
  "waiter.noMenu": "لا توجد منتجات متاحة",
  "waiter.selectTable": "اختر طاولة",
  "waiter.noTable": "بدون طاولة",
  "waiter.table": "طاولة",
  "waiter.note": "ملاحظة (اختياري)",
  "waiter.send": "إرسال",
  "waiter.orderSent": "تم إرسال الطلب",
  "waiter.error": "حدث خطأ",
  "sidebar.recap": "ملخص",
  "sidebar.dailyReport": "التقرير اليومي",
  "sidebar.ordersStats": "الطلبات",
  "sidebar.sales": "المبيعات",
  "sidebar.profile": "ملفي الشخصي",
  "sidebar.password": "كلمة المرور",
  "sidebar.contact": "اتصل بنا",
  "sidebar.help": "مركز المساعدة",
  "sidebar.logout": "تسجيل الخروج",
  "sidebar.more": "المزيد",
  "settings.addZone": "إضافة منطقة",
  "settings.editZone": "تعديل المنطقة",
  "settings.zoneNamePlaceholder": "مثال: التراس",
  "settings.unzoned": "بدون منطقة",
  "settings.confirmDeleteZone": "حذف هذه المنطقة؟ سيتم نقل الطاولات إلى \"بدون منطقة\".",
  "settings.brandColor": "لون العلامة التجارية",
  "settings.brandColorHint": "سيتم استخدام هذا اللون للأزرار والعناصر البارزة في قائمة العملاء.",
  "settings.bgColor": "لون الخلفية",
  "settings.bgColorHint": "لون خلفية قائمة العملاء.",
  "settings.bgPattern": "نمط الخلفية",
  "settings.bgPatternHint": "النمط المعروض على خلفية قائمة العملاء.",
  "settings.productLayout": "تخطيط المنتجات",
  "settings.productLayoutHint": "اختر كيفية عرض المنتجات في قائمتك.",
  "settings.layoutList": "قائمة",
  "settings.layoutCarousel": "عرض دوار",
  ...
  "client.poweredBy": "بدعم من",
  "client.allRightsReserved": "جميع الحقوق محفوظة.",
  "settings.infoOrder": "ترتيب المعلومات",
  "settings.infoOrderHint": "اسحب لإعادة ترتيب المعلومات في قائمة العملاء.",
  "settings.openingHours": "أوقات العمل",
  "settings.open": "مفتوح",
  "settings.closed": "مغلق",
  "settings.addSlot": "إضافة وقت",
  ...
  "settings.tiktokPlaceholder": "https://tiktok.com/@مطعمك",
  "settings.twitter": "إكس (تويتر)",
  "settings.twitterPlaceholder": "https://x.com/مطعمك",
