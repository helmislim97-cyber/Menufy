...
const fr: Dict = {
  ...
  "client.assistance.instructions": "Besoin d'aide ? Entrez votre nom et votre message, et un serveur viendra vous voir.",
...
const ar: Dict = {
  ...
  "client.assistance.instructions": "تحتاج مساعدة؟ أدخل اسمك ورسالتك وسيأتيك أحد النوادل.",
