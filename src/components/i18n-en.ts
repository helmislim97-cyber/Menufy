export const en: Record<string, string> = {
  ...
  "cashier.recentPayments": "Recent payments",
  "cashier.noPayments": "No payments today",
  "cashier.table": "Table",
  "cashier.method.cash": "Cash",
  "cashier.method.card": "Card",
  "cashier.method.online": "Online",
  "cashier.requestVoid": "Request void",
  "cashier.voidRequested": "Void requested",
  "cashier.voidRequestedToast": "Request sent — awaiting approval",
  "cashier.voidModalTitle": "Request payment void",
  "cashier.voidReason.customer_refund": "Customer refund",
  "cashier.voidReason.wrong_order": "Wrong order",
  "cashier.voidReason.entry_mistake": "Entry mistake",
  "cashier.voidReason.other": "Other",
  "cashier.confirm": "Confirm",
  "cashier.cancel": "Cancel",
  "cancel.request": "Request cancellation",
  "cancel.requested": "Cancellation requested — awaiting approval",
  "cancel.error": "Action failed",
  "cancel.modalTitle": "Request order cancellation",
  "cancel.pickOrder": "Which order?",
  "cancel.order": "Order",
  "cancel.items": "items",
  "cancelReason.wrong_order": "Wrong order",
  "cancelReason.customer_left": "Customer left",
  "cancelReason.duplicate": "Duplicate",
  "cancelReason.out_of_stock": "Out of stock",
  "cancelReason.other": "Other",
  "edit.request": "Request edit",
  "edit.requested": "Edit requested — awaiting approval",
  "edit.error": "Action failed",
  "edit.modalTitle": "Edit order",
  "edit.newTotal": "New total",
  "editReason.wrong_item": "Wrong item",
  "editReason.customer_changed": "Customer changed their mind",
  "editReason.out_of_stock": "Out of stock",
  "editReason.other": "Other",
  "approvals.removed": "removed",
  ...
  "approvals.action.cancel": "Cancellation",
  "approvals.action.edit": "Edit",
  "approvals.action.void_payment": "Void payment",
  ...
  "client.openingHours": "Opening hours",
  "client.today": "Today",
  ...
  "sidebar.group.activity": "Activity",
  "sidebar.group.management": "Management",
  "sidebar.group.stats": "Statistics",
  "sidebar.group.account": "Account",
  "sidebar.home": "Home",
  "sidebar.orders": "Orders",
  "sidebar.assistance": "Calls",
  "sidebar.kitchenMode": "Kitchen mode",
  "sidebar.cashierMode": "Cashier mode",
  "sidebar.loyalty": "Loyalty",
  "sidebar.menu": "My menu",
  "sidebar.tables": "My tables",
  "sidebar.appearance": "Appearance",
  "sidebar.info": "General info",
  "sidebar.notifications": "Notifications",
  "sidebar.roles": "Roles",
  "sidebar.rolePerms": "Roles & permissions",
  "sidebar.staff": "Staff",
  "staff.switchUser": "Switch user",
  "staff.exit": "Exit",
  "waiter.title": "Service",
  "waiter.subtitle": "Floor & orders",
  "waiter.empty": "No active orders",
  "waiter.total": "Total",
  "waiter.markPaid": "Collect payment",
  "waiter.newOrder": "New order",
  "waiter.noMenu": "No products available",
  "waiter.selectTable": "Select a table",
  "waiter.noTable": "No table",
  "waiter.table": "Table",
  "waiter.note": "Note (optional)",
  "waiter.send": "Send",
  "waiter.orderSent": "Order sent",
  "waiter.error": "An error occurred",
  "sidebar.recap": "Recap",
  "sidebar.dailyReport": "Daily report",
  "sidebar.ordersStats": "Orders",
  "sidebar.sales": "Sales",
  ...
  "settings.editZone": "Edit zone",
  "settings.zoneNamePlaceholder": "e.g. Terrace",
  "settings.unzoned": "Unzoned",
  "settings.confirmDeleteZone": "Delete this zone? Tables will be moved to \"Unzoned\".",
  "settings.brandColor": "Brand color",
  "settings.brandColorHint": "This color will be used for buttons and accents on your customer menu.",
  "settings.bgColor": "Background color",
  "settings.bgColorHint": "Background color of your customer menu.",
  "settings.bgPattern": "Decorative pattern",
  "settings.bgPatternHint": "Pattern displayed on the background of your customer menu.",
  "settings.productLayout": "Product layout",
  "settings.productLayoutHint": "Choose how products are displayed on your menu.",
  "settings.layoutList": "List",
  "settings.layoutCarousel": "Carousel",
  ...
  "settings.addSlot": "Add time slot",
  ...
  "settings.tiktokPlaceholder": "https://tiktok.com/@your-restaurant",
  "settings.twitter": "X (Twitter)",
  "settings.twitterPlaceholder": "https://x.com/your-restaurant",
