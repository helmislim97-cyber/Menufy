...
export function MenufyBrand({ href = "https://menufy-tau.vercel.app" }: { href?: string }) {
  return (
    <a href={href} target="_blank" rel="noreferrer" className="inline-flex items-center transition-colors">
      <span className="text-xs font-extrabold tracking-tight text-[#1c1f16]/60 hover:text-[#1c1f16]">Menu<span className="text-primary">fy</span></span>
    </a>
  );
}
